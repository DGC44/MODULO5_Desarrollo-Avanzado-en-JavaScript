...
async function hacerReserva(nombreCliente, mesasSolicitadas) {
  try {
    ...
    mesasDisponibles -= mesasSolicitadas; // Descontamos las mesas reservadas
    console.log(`Reservando ${mesasSolicitadas} mesa(s) para ${nombreCliente}...`);
...
// Llamadas de prueba
hacerReserva("Juan Pérez", 3);     // Caso exitoso probable
hacerReserva("Ana Gómez", 4);      // Puede fallar por falta de mesas
hacerReserva("Diana Gant", 2); 
hacerReserva("Miguel Basulto", 1);     
